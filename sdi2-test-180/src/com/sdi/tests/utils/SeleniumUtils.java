...
public class SeleniumUtils {
		...
		static public void ClickOpcion(WebDriver driver, String opcionclick)
		{
			//Pinchamos la opcion opcionclick
			By locator = By.id(opcionclick);
			driver.findElement(locator).click();			
		...
		//espera que se cargue el elemento buscado para que puede hacer las operaciones que
		//quisieras sino la pagina salta muy rapido y no puedes ver nada
