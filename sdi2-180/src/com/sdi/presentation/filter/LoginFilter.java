...
initParams = {
@WebInitParam(name = "LoginParam", value = "/index.xhtml", description = "Pagina de loggueo")
})
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (session.getAttribute("LOGGEDIN_USER") == null) {//objeto guardado en login
			String loginForm = config.getInitParameter("LoginParam");
			// Si no hay login, redirección al formulario de loginF
